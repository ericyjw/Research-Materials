...
//        args = new String[]{"../result/corr_simulated_iter_6.csv" };
//        args = new String[]{"../result/corr_real.csv" };
        ...
        try {
            ...
            ec.exportFile(new File("../network_graph/png/" + export_filename + ".png"));
            ec.exportFile(new File("../network_graph/pdf/" + export_filename + ".pdf"));
            ec.exportFile(new File("../network_graph/svg/" + export_filename + ".svg"));
